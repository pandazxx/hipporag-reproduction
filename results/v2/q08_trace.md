# Trace — q08  [deep_multi_hop, expect=HippoRAG]

**Question:** Who is the manager of the person whose brother works at Amazon?

**Expected answer:** Marcus

**Required facts:** ['m13', 'm14', 'm28', 'm29']

## Step 1 — query→triple top-K (cosine on triple-text embeddings)

| Cosine | Subject | Predicate | Object |
|---|---|---|---|
| 0.395 | `David` | works at | `Amazon` |
| 0.394 | `Sam` | has manager | `Jennifer` |
| 0.385 | `Sam` | has manager | `Marcus` |
| 0.384 | `Jennifer` | is manager of | `Sam` |
| 0.372 | `Marcus` | is manager of | `Sam` |
| 0.349 | `Amazon` | has headquarters at | `Seattle` |
| 0.326 | `Sam` | works at | `StartupCo` |
| 0.326 | `Sam` | works at | `StartupCo` |
| 0.315 | `Marcus` | works at | `StartupCo` |
| 0.312 | `Sam` | works at | `TechCorp` |
...
|---|---|---|---|---|
| 1 | `m28` | 0.00313 | ✓ | Sam's new manager at StartupCo will be Marcus. |
| 2 | `m03` | 0.00272 |  | Sam's manager at TechCorp is Jennifer. |
| 3 | `m34` | 0.00266 |  | Sam booked flights to Boston for May 13 through 17 to be the… |
| 4 | `m23` | 0.00227 |  | Sam is feeling burned out at TechCorp due to long hours and … |
| 5 | `m37` | 0.00226 |  | Sam's Spanish practice has slipped to once a week since star… |
